 ...
 *  @package    Dwo
 */
class Dwo_Form_WeborderUpgradeshop extends Dwo_ActionForm
{
 ...
 *  @package    Dwo
 */
class Dwo_Action_WeborderUpgradeshop extends Dwo_ActionClass
{
    /**
     *  セッションチェック
     */
