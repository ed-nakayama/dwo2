...
今回のご注文の内容です。
ご注文受付日　：<?php echo e(substr($weborderheader->order_date, 0 ,4)); ?>年<?php echo e(substr($weborderheader->order_date, 5 ,2)); ?>月<?php echo e(substr($weborderheader->order_date, 8, 2)); ?>日
...
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
<?php /**PATH /var/www/dwo2/resources/views/mail_templates/maintInfoUpdate.blade.php ENDPATH**/ ?>