...
承認されていません。
<?php echo e(substr($acceptance->order_date2w_ago, 0 ,4)); ?>年<?php echo e(substr($acceptance->order_date2w_ago, 5 ,2)); ?>月<?php echo e(substr($acceptance->order_date2w_ago, 8, 2)); ?>日 15時までに「承認」されない場合、ご注文はキャンセルされます。
お客様にご確認下さい。
...
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
<?php /**PATH /var/www/dwo2/resources/views/mail_templates/demandUpgrade.blade.php ENDPATH**/ ?>