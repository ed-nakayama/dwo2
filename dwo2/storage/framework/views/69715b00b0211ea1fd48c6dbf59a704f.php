...
<?php echo e(html()->form('POST', '/top/extramail/store')->attribute('name', 'frm')->style('margin:0px;')->open()); ?>

<?php echo e(html()->hidden('mail', $mail)); ?>
...
<table border="0" width="60%">
	...
	<tr>
	<tr>
		<td nowrap>変更後のメールアドレス：　<?php echo e($mail); ?></td>
	<tr>
	<tr>
		<td nowrap>
			変更後の受信設定：　
...
<?php endif; ?>
<?php /**PATH /var/www/dwo2/resources/views/weborder/top/extramailconfirm.blade.php ENDPATH**/ ?>