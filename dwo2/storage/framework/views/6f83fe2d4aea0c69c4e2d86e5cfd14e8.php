...
承認されていません。
<?php echo e(substr($acceptance->order_date2w_ago, 0 ,4)); ?>年<?php echo e(substr($acceptance->order_date2w_ago, 5 ,2)); ?>月<?php echo e(substr($acceptance->order_date2w_ago, 8, 2)); ?>日（２週間以内）までに「承認」されない場合、ご注文はキャンセルされます。
お客様にご確認下さい。
...
商品納品先
納品先名称　　：<?php echo e($weborderheader->dest_name1); ?><?php echo e($weborderheader->dest_name2); ?>

納品先郵便番号：<?php echo e($weborderheader->dest_post); ?>

納品先住所　　：<?php $__currentLoopData = $prefList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if($weborderheader->dest_pref_cd == $kenlist-> pref_cd): ?><?php echo e($kenlist->pref_name); ?><?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php echo e($weborderheader->dest_address1); ?><?php echo e($weborderheader->dest_address2); ?><?php echo e($weborderheader->dest_address3); ?>
...
--------------------------------------------------------------------
運賃　　　　　　：当社負担
サプライ二重梱包：<?php if($weborderheader->double_package_type == '1'): ?>
有
<?php else: ?>
無
<?php endif; ?>
...
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
<?php /**PATH /var/www/dwo2/resources/views/mail_templates/demand.blade.php ENDPATH**/ ?>