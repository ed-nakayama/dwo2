...
<table width="550px">
	<tr>
		<td>
		<h4>▼ご使用者のお客様番号と電話番号を入力してください。</h4>
		</td>
	</tr>
{%if count($errors)%}
...
<input type="hidden" name="action_weborderUpgrade" value="true">
...
<table>
	...
	<tr>
		<td>使用者電話番号</td>
		<td><input type="text" name="cust_tel" value="{%$form.cust_tel%}" maxlength="13" style="ime-mode: disabled;">　※ハイフン無しで入力</td>
	</tr>
	<tr>
