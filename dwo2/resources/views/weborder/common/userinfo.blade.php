					...
					<td>
						<table border="1" cellspacing="0" frame="hsides" rules="rows" width="370px">
							<tr>
								...
								<td width="33%">&nbsp;{{ session('agentView')->cust_num }}</td>
								<td width="20%">&nbsp;</td>
								<td width="30%">&nbsp;</td>
							</tr>
							<tr>
								<td class="item">貴社名</td>
								<td colspan="3">&nbsp;{{ session('agentView')->name1 . session('agentView')->name2 }}</td>
							</tr>
							<tr>
								<td class="item">ご担当者</td>
								<td colspan="3">&nbsp;{{ session('agentView')->contact_name1 }}&nbsp;&nbsp;様</td>
							</tr>
						</table>
					</td>
				</tr>
