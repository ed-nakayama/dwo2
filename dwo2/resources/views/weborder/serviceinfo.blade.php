    ...
    <td width="80%">
      <table id="pap_info">
        ...
        <tr>
          <td align="center">
            <div id="pap_foot">
              <div class="foot_info_logo"><img src="{{ asset('assets/cust/img/pap_foot_logo.png') }}" width="161" height="118" alt="弥生PAP" /></div>
              <div class="foot_info"><img src="{{ asset('assets/cust/img/pap_foot_tel.png') }}" width="379" height="66" alt="弥生PAP会員専用電話サポート（フリーダイヤル）0120-714-841" />
