...
以下のご注文はご購入のお客様（ユーザー登録のお客様）に「個人情報保護方針」についての承認確認メールを送信済みです。
{{ substr($ago2week,0,4) }}年{{ substr($ago2week,5,2) }}月{{ substr($ago2week,8,2) }}日（２週間以内）までに「承認」いただければご注文の予約受付完了です。

「否認」の場合や上記期限までに「承認」頂けない場合、ご予約いただきましたご注文はキャンセルされます。

ご予約されました製品は、予約受付完了後、出荷可能日になりましたら出荷手配をさせていただきます。
