...
{{ substr($ago2week,0,4) }}年{{ substr($ago2week,5,2) }}月{{ substr($ago2week,8,2) }}日（２週間以内）までに「ご承認」いただいた時点で注文確定となります。
弊社営業日15時までにご承認いただきますと、翌営業日に出荷致します。
...
@if (!empty($orderInfo->delivery_name) )
--------------------------------------------------------------------
